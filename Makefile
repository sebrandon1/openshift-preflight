...
.PHONY: build
build:
	go build -o $(BINARY) -ldflags "-X github.com/sebrandon1/openshift-preflight/version.commit=$(VERSION) -X github.com/sebrandon1/openshift-preflight/version.version=$(RELEASE_TAG)" cmd/preflight/main.go
...
.PHONY: build-linux-$(1)
build-linux-$(1):
	GOOS=linux GOARCH=$(1) go build -o $(BINARY)-linux-$(1) -ldflags "-X github.com/sebrandon1/openshift-preflight/version.commit=$(VERSION) \
				-X github.com/sebrandon1/openshift-preflight/version.version=$(RELEASE_TAG)" cmd/preflight/main.go
endef
...
test:
	...
	-ldflags "-X github.com/sebrandon1/openshift-preflight/version.commit=bar -X github.com/sebrandon1/openshift-preflight/version.version=foo"
